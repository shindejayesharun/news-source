...
public class CollectionsFragment extends Fragment {
    ...
    private void setData() {
        if(prefManager.getLanguage()==0) {
            ...
            collectionsModels.add(new CollectionsModel("HeadLines", "https://lh3.ggpht.com/16hfpPK4nois_ekV4s4PRXYinW3MN_5EnUNq0sdaMvkfVECIVrMa44HBUVxSWyRB4CjtDlDYvg=p", "https://www.bbc.com/hindi"));
            collectionsModels.add(new CollectionsModel("India", "https://lh5.ggpht.com/MMoPETUaDbUB1bO3KAi3cKQ_lzssju3VEp9ZPauGIamgSniMr4nV2SVkVvG-rKUJSLQJP84q7EA=p", "https://www.bbc.com/hindi/india"));
            collectionsModels.add(new CollectionsModel("World", "https://lh3.googleusercontent.com/D5g44boSmliEh79IQfM-LqzIdG-EVoAc4FM6VJVo69GshEIiZ06iulL5Ggx03VfSoIe-U6vFjA=p", "https://www.bbc.com/hindi/international"));
            collectionsModels.add(new CollectionsModel("Entertainment", "https://lh6.ggpht.com/M-7V3aFj1BEw9EYBVHdLFmjCerci3j2MvsB43zu6-9iu-znG_WuOYrz5urJlStV5n59mW0WY5Q=p", "https://www.bbc.com/hindi/entertainment"));
            collectionsModels.add(new CollectionsModel("Sports", "https://lh4.ggpht.com/NyQryeBboxLw72N3_3mAHBYMuWlMaZ1RJHGRdF30RDICgv2-9Jupc2GzY2XeVdgaV3nbNaXb=p", "https://www.bbc.com/hindi/sport"));
            collectionsModels.add(new CollectionsModel("Science", "https://lh6.ggpht.com/fJKuBX6iUFA_nPU2_2bIXcrTf3osSPhgBCL0sGqR2pZo-P6uZpiSmHW098W4I-CQHmsxZBd4=p", "https://www.bbc.com/hindi/science"));
            collectionsModels.add(new CollectionsModel("Health", "https://lh3.ggpht.com/r4EKXwEo49BFQUa3OVZ8FC3j6teq_hUrmGcO4fI8BqoBgWSVJyu6D-vvXs9wGO7e_BKMbeqo4dk=p", "https://www.bbc.com/hindi/social"));
            collectionsModels.add(new CollectionsModel("Video", "https://lh4.ggpht.com/0JsT7seg_L1MnpCuWZvJ6CJCHpkCawqEMdOr8Iw_NWjNUyTqWZJZNDbfa6kUGg-q1KN4FiUPaw=p", "https://www.bbc.com/hindi/media/video"));
